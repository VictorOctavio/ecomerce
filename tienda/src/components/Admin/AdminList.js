...
const AdminList = ({ products, setEdit, setProduct, deleteProduct, setDescription }) => {
    ...
    const handleEdit = (product) => {
        ...
        setProduct({
            ...
            tallas: product.information.tallas,
            information: {
                oferta: {
                                ...
                                <Accordion.Collapse eventKey={i + 1}>
                                    <Card.Body style={{ display: 'flex', justifyContent: 'space-between' }}>
                                        ...
                                        <div className="buttons">
                                            {product.state ? (
                                                <button className="btn btn-outline-dark" onClick={() => handleEdit(product)}>Oculto</button>
                                            ) : <button className="btn btn-outline-primary">Visible</button>}
